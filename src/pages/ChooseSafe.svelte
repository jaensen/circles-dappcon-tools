...
<div class="hero min-h-screen bg-blue mx-auto w-full flex flex-col justify-center select-safe">
        <div>
            <div class="text-center text-neutral-content">
                <h1 class="mb-5 text-5xl font-bold text-primary">Select your safe</h1>
                {#if circlesSafes && circlesSafes.length > 1}
                    <p class="mb-5 text-primary">You have multiple Circles Safes. Please select one from below.</p>
                ...
                {:else if circlesSafes && circlesSafes.length === 0}
                    <p class="mb-5 text-primary">Your wallet isn't connected to any Circles Safe yet.</p>
                {/if}
            </div>
    ...
    <div
        class="h-screen max-h-[50vh] overflow-hidden w-full mb-5 flex justify-center"
    >
        ...
        <a on:click class="flex p-3 text-center">
            <div class="flex-grow text-neutral-content">
                <button
                    ...
                    class="w-1/3 btn btn-primary text-primary bg-blue"
                    >Import</button
                >
            </div>
        </a>
