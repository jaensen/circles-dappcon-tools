    ...
    <div class="hero-content">
        <div>
            <div class="text-center text-neutral-content">
                ...
                <p class="mb-5">Connect the EOA you want to use to interact with your Circles account.</p>
            </div>
            <div class="text-center text-neutral-content">
                {#if $connectedWallet}
                    <div>
                        <div class="mb-5 text-xl font-bold">{ $connectedWalletAddress }</div>
                        <div  class="mb-5 text font-bold">Connected to {$connectedWallet?.label}</div>
                        <button class="btn btn-secondary" on:click={() => { disconnect($connectedWallet) }}>Disconnect</button>
                    </div>
                {:else}
                    <div>
